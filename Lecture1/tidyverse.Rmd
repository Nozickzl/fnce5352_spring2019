...
who <- who[,c(1:3, 6, 25:26, 28:33, 35:36, 38:43, 45:46, 48:53, 56:57, 59:64, 71:72, 74:79, 82:83, 85:90)]
...
who %>%
  ...
  mutate(group = str_replace(group, "new_*", ""),
         ...
         age = ifelse(str_length(age) > 2,
                      ...
                      ifelse(age=='04', '0-4', str_c(age, "+"))),
         age = ordered(age, levels=c('0-4', '5-14', '15-24', '25-34', '35-44', '45-54', '55-64', '65+'))) %>%
